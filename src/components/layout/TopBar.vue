<template>
	<div class="h-12">
		<div class="fixed w-full ">
			<div
				id="nav"
				class="bg-gray-800 border-t-4 border-teal-400 no-print h-12 px-3"
			>
				...
				<!-- v-if="authenticated" -->
				<div
					class="flex justify-between h-full items-center pl-2 sm:pl-0 text-gray-100 text-sm font-semibold"
				>
