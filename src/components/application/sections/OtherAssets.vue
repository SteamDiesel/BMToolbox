<template>
	<div class="mt-6">
			<h2 class="text-xl">Other Assets</h2>
			...
			>
				...
				>
					...
					<svg viewBox="0 0 24 24" class="h-5 w-5"><path class="primary" d="M2 5c0 1.1.9 2 2 2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5zm16 11a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/><path class="secondary" d="M4 3h11a2 2 0 0 1 2 2v2H4a2 2 0 1 1 0-4z"/></svg>
