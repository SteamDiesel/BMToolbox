	...
	<div class="w-full bg-gray-200 p-2">
		...
		<div class="mt-6">
			...
			<DomesticExpenses
				...
				:key="index"
				:domestic_expenses="domestic_expenses"
			>
				<button
					class="relative bg-gray-300 hover:bg-red-200 p-2 shadow-lg rounded-full no-print text-xs"
				@click="dropFromArray({array: person.domestic_expenses, object: domestic_expenses, type: 'domestic_expenses', index: index, person: person})"
				>
...
import DomesticExpenses from "@/components/application/DomesticExpenses.vue";
export default {
	name: "Person",
	components: {
		FormField,
