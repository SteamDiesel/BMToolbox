		...
		<div class="flex flex-wrap">
			...
			@copy="copyClipboard('#'+court_judgement.monthly_payment)">
				...
				<input
					...
					@keyup.87="court_judgement.monthly_payment = court_judgement.monthly_payment * 4.33"
					@keyup.70="court_judgement.monthly_payment = court_judgement.monthly_payment * 2.166"
					@keyup.81="court_judgement.monthly_payment = court_judgement.monthly_payment * 0.33"
					@keyup.89="court_judgement.monthly_payment = court_judgement.monthly_payment * 0.0833"
					@change="saveApp"
					type="number"
					class="form-input text-center"
				/>
