		...
		<div class="flex flex-wrap">
			...
			<FormField class="w-1/3" :no_copy="true">
				...
				>
					...
					<option value="Part 9 Debt Agreement"
						>Part 9 Debt Agreement</option
					>
				</select>
			</FormField>
		...
		<div class="flex flex-wrap">
			...
			>
				...
				<input
					...
					@keyup.87="
						bankruptcy.monthly_payment =
							bankruptcy.monthly_payment * 4.33
					"
					@keyup.70="
						bankruptcy.monthly_payment =
							bankruptcy.monthly_payment * 2.166
					"
					@keyup.81="
						bankruptcy.monthly_payment =
							bankruptcy.monthly_payment * 0.33
					"
					@keyup.89="
						bankruptcy.monthly_payment =
							bankruptcy.monthly_payment * 0.0833
					"
					@change="updateField"
					type="number"
					class="form-input text-center"
