		...
		<div class="flex flex-wrap">
			...
			>
				...
				<input
					...
					@keyup.87="
						credit_default.monthly_payment =
							credit_default.monthly_payment * 4.33
					"
					@keyup.70="
						credit_default.monthly_payment =
							credit_default.monthly_payment * 2.166
					"
					@keyup.81="
						credit_default.monthly_payment =
							credit_default.monthly_payment * 0.33
					"
					@keyup.89="
						credit_default.monthly_payment =
							credit_default.monthly_payment * 0.0833
					"
					@change="updateField"
					type="number"
					class="form-input text-center"
