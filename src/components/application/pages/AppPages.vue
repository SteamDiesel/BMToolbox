		...
		<div class="w-full xl:flex px-4 justify-between bg-gray-200 no-print">
			...
			<div class="flex flex-wrap">
				...
				<div
					...
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': Identity, 'border-b': !Identity}"
				...
				<div
					...
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': Addresses, 'border-b': !Addresses}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Addresses</div>
				<div
					@click="switchPage('Employers')"
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': Employers, 'border-b': !Employers}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Employers</div>
				...
				<div
					...
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': Vehicles, 'border-b': !Vehicles}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Vehicles</div>
				<div
					@click="switchPage('CreditCards')"
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': CreditCards, 'border-b': !CreditCards}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Credit Cards</div>
				<div
					@click="switchPage('OtherLoans')"
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': OtherLoans, 'border-b': !OtherLoans}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Other Loans</div>
				<div
					@click="switchPage('OtherAssets')"
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': OtherAssets, 'border-b': !OtherAssets}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Other Assets</div>
				<div
					@click="switchPage('DomesticExpenses')"
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': DomesticExpenses, 'border-b': !DomesticExpenses}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Domestic Expenses</div>
				<div
					@click="switchPage('Defaults')"
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': Defaults, 'border-b': !Defaults}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Credit Impairments</div>
				<div
					@click="switchPage('BalanceSheet')"
					:class="{'text-blue-600 bg-gray-100 border-t border-l border-r rounded-t-lg font-semibold': BalanceSheet, 'border-b': !BalanceSheet}"
					class="px-3 cursor-pointer py-1 hover:text-blue-400"
				>Balance Sheet</div>
			</div>
			<div>
		...
		<div class="xl:flex xl:justify-around ml-10">
			...
			>
				<div>
					...
					<select name="role" :id="'app_role' + index" v-model="person.role">
						<option v-for="(role, index) in app_roles" :key="index" value="role">{{role}}</option>
					</select>
					<hr />
				</div>
					...
					<div v-if="Identity">
						...
						<Kids :key="'kid'+index" :person_index="index" :people="application.people" :person="person" />
					</div>
