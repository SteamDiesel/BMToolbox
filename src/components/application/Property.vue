		...
		<div class="flex flex-wrap">
			...
			>
				...
				<input
					...
					@keyup.87="
						property.rental_income = property.rental_income * 4.33
					"
					@keyup.70="
						property.rental_income = property.rental_income * 2.166
					"
					@keyup.81="
						property.rental_income = property.rental_income * 0.33
					"
					@keyup.89="
						property.rental_income = property.rental_income * 0.0833
					"
					@change="updateField"
					type="number"
					class="form-input text-center"
		...
		<div class="flex flex-wrap">
			...
			>
				...
				<input
					...
					@keyup.87="
						property.first_mortgage_payment =
							property.first_mortgage_payment * 4.33
					"
					@keyup.70="
						property.first_mortgage_payment =
							property.first_mortgage_payment * 2.166
					"
					@keyup.81="
						property.first_mortgage_payment =
							property.first_mortgage_payment * 0.33
					"
					@keyup.89="
						property.first_mortgage_payment =
							property.first_mortgage_payment * 0.0833
					"
					@change="updateField"
					type="number"
					class="form-input text-center"
