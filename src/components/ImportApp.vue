<template>
	<div class="h-full flex flex-col justify-between">
		<div>
			...
			<textarea @change="check" class="w-full h-32" v-model="app_import_field" placeholder="Remember to include the curly braces at both ends '{}'" ></textarea>
		</div>
		
		
		
		<div>
			<div class="flex justify-around my-4" v-if="import_staging.loan_calculator">
