...
export default new Vuex.Store({
	state: {
		...
		user_preferences: {
			...
			app_statuses: [
				{ value: "Lead", color: "#f7fafc", order: 1 },
				{ value: "Application", color: "#f7fafc", order: 2 },
				{ value: "Submitted", color: "#f7fafc", order: 3 },
				{ value: "Approved", color: "#48bb78", order: 4 },
				{ value: "Docs Out", color: "#f7fafc", order: 5 },
				{ value: "Settlement", color: "#f7fafc", order: 6 },
				{ value: "Settled", color: "#4299e1", order: 7 },
				{ value: "Declined", color: "#a0aec0", order: 8 },
				{ value: "Withdrawn", color: "#a0aec0", order: 9 },
			],
			vehicle_price: 30000,
			custom_one: 0,
			custom_one_label: "Custom Field 01",
